...
export const HeaderBurger: FC<IHeaderBurgerProps> = ({ isClicked, setIcClicked }) => {
  ...
  return (
    <div className={styles.a}>
      <div
        className={isActive ? styles.overlay : styles.overlay + ' ' + styles.overlay_hidden}
      ...
      <div className={styles.burger} onClick={() => setIsActive(!isActive)}>
        ...
        <span
          className={!isActive ? styles.burger__line : styles.burger__line + ' ' + styles.burger__line_short}
        ></span>
      </div>

      <div
        className={isActive ? styles.navbar_container + ' ' + styles.navbar_container_active : styles.navbar_container}
      >
        {isActive && <AppNavBar />}
      </div>
    </div>
