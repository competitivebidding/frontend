...
export type GetAuctionsQuery = { __typename?: 'Query', getAuctions: Array<{ __typename?: 'Auction', createdAt: any, description: string, finishedAt: any, id: number, sortOrder: number, startedAt: any, title: string, updatedAt: any, bids?: Array<{ __typename?: 'Bid', id: number, userId: number, auctionId: number, bitPrice: number, createdAt: any, updatedAt: any, user?: { __typename?: 'UserPublic', username: string, firstname?: string | null, lastname?: string | null, avatarUrl?: string | null } | null }> | null, creator: { __typename?: 'UserPublic', username: string, firstname?: string | null, lastname?: string | null, avatarUrl?: string | null }, status: { __typename?: 'Status', id: number, name: string }, winner?: { __typename?: 'UserPublic', username: string, firstname?: string | null, lastname?: string | null, avatarUrl?: string | null } | null }> };
...
export type SendMessageMutation = { __typename?: 'Mutation', sendMessage?: { __typename?: 'Message', id: number, userId: number, roomId: number, content: string, createdAt: any, updatedAt: any } | null };
...
export type RemoveMessageMutation = { __typename?: 'Mutation', removeMessage?: { __typename?: 'Message', roomId: number, updatedAt: any, userId: number, content: string, id: number, createdAt: any } | null };

export type UpdateMessageMutationVariables = Exact<{ [key: string]: never; }>;


export type UpdateMessageMutation = { __typename?: 'Mutation', updateMessage?: { __typename?: 'Message', content: string, createdAt: any, id: number, roomId: number, updatedAt: any, userId: number } | null };
...
export type RemoveMyRoomMutation = { __typename?: 'Mutation', removeMyRoom?: { __typename?: 'Room', id: number, ownerId: number, title: string, description?: string | null, createdAt: any, updatedAt: any } | null };
...
export type NewMessageSubscription = { __typename?: 'Subscription', newMessage: { __typename?: 'Message', content: string, createdAt: any, id: number, updatedAt: any, roomId: number, userId: number } };
...
export const UpdateMessageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateMessage"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateMessage"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"roomId"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"userId"}}]}}]}}]} as unknown as DocumentNode<UpdateMessageMutation, UpdateMessageMutationVariables>;
